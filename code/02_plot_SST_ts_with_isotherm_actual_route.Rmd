...
### **Figure 1) Map.** <span style="font-size: 16pt">Estimated shipping route (gray circles) and actual route (green). The green icon represents the most recently known location. The 4 potential turtle eastern North Pacific deployment locations for July 2023 are shown as colored circles.</span>
