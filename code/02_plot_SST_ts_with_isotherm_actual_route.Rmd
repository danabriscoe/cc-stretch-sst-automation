...
p_insitu_sst <- 
  ...
  scale_y_continuous(limits=c(14,27), breaks=seq(14,26,2)) +
  scale_x_longitude(xmin=120, xmax=255, step=10) +
  ...
  theme_minimal() +
  theme(legend.position = "none") + labs(x="Date", y = "SST (°C)")
...
#### <span style="font-size: 14pt"> <span style="color:green">Daily SST measurements</span> recorded on board the ship. The black horizontal line at 17°C is a reference for optimal temperatures during turtle release.</span>

#### <span style="font-size: 14pt"> Use the mouse to hover over each data point for detailed information.</span>

```{r insitu-ggplot, fig.height=1.5}
fig_2
