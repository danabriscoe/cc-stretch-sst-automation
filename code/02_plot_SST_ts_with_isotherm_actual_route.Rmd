...
# make ship icon
ship_icon <- makeAwesomeIcon(icon= 'ship', markerColor = '#76B7B2', iconColor = 'white', library = "fa")
...
#### <span style="font-size: 14pt"> Estimated shipping route (gray line) and the actual route in green. The ship icon represents the <span style="color:#76B7B2">location of turtle release on July 10, 2023</span>.<br></span>
