...
#### [The tabs below show the daily 5km SST and SST anomalies (SSTA) for **`r getZ(enddate_ras)`**.]{style="font-size: 14pt"}
...
#### [The [ **light green lines and ship icon represent the 2024 route**]{style="color:#59a14f"} for the ship of opportunity.]{style="font-size: 14pt"}

#### [For comparison, the [ **dark green lines represent the location the 2023 shipping route**]{style="color:darkgreen"}. The [dark green icon]{style="color:#31572c"} represents the location of turtle release on July 10, 2023.]{style="font-size: 14pt"} <br><br>


#### [**The** [**blue icon represents the 2024 potential release location**]{style="color: #023e8a"} **(39.63°N, 149°W)**. [**The current SST at this location is: **]{style="color: #023e8a"} [**`r xtract_sst_poss_cohort2_loc$val`°C**]{style="color:#E15759"}.]{style="font-size: 14pt"}<br><br> 


#### [The current SST at [last year's release location]{style="color:darkgreen"} is: `r xtract_sst_recent_loc$val`°C. This 2024 SST value is **`r xtract_ssta_recent_loc_enddate$val`°C** warmer than the long-term average.]{style="font-size: 14pt"} <br>[*Note, the 2024 SST anomaly product reflects the daily value as of 2024-07-03, due to server maintenance with Coral Reef Watch over the holiday weekend. However the SST product remains up to date.*]{style="font-size: 12pt"}
