...
# sort this out later...
if(year(params$enddate) == 2024 | 2025){
...
#### [Current conditions are based on the latest remotely sensed data from [NOAA Coral Reef Watch](https://coralreefwatch.noaa.gov/product/5km/index_5km_sst.php) and [GHRSST L4](https://podaac.jpl.nasa.gov/GHRSST). For comparison, the SSTA conditions are also shown for exactly 1 year prior (`r getZ(enddate_ras) - 366`).]{style="font-size: 14pt"}<br><br>

#### The [**light green lines and ship icon represent the 2024 route and turtle release location on July 7, 2024**]{style="color:#59a14f"}. <br>The in situ SST measurement on that date was: 18°C.<br><br>

#### For comparison, the [**dark green lines and solid icon represent the 2023 route and turtle release location on July 10, 2023**]{style="color:darkgreen"}.<br>The in situ SST measurement on that date was: 24.8°C. <br><br>
...
<!-- #### [*Note, the 2024 SST anomaly product reflects the daily value as of 2024-07-03, due to server maintenance with [Coral Reef Watch](https://coralreefwatch.noaa.gov) over the holiday weekend.* <br>However the daily SST product remains up to date.]{style="font-size: 13pt"}<br><br> -->

<!-- #### [The current SST at [last year's release location]{style="color:darkgreen"} is: `r xtract_sst_recent_loc$val`°C. This 2024 SST value is **`r xtract_ssta_recent_loc_enddate$val`°C** warmer than the long-term average.]{style="font-size: 14pt"} <br> -->

<!-- #### [In 2023, SSTs at the release location were `r xtract_ssta_recent_loc_previous_dt$val`°C warmer than the long-term average.]{style="font-size: 14pt"}<br><br> -->
...
#### [For each longitude, the darker lines with circles represent the weekly SST average since 2023.]{style="font-size: 14pt"}<br>
