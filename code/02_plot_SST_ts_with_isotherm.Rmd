...
print(str_c('Daily 5km SST map for ', getZ(enddate_ras), '. The black lines represent the 17 degree C isotherm. Thermal Corridor study area is outlined in white.'))
```
