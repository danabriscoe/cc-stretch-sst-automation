...
longterm_df_formatted$facet_ID <- factor(longterm_df_formatted$ID,      # Reordering group factor levels
                         levels = c("150 W", "160 W", "145 W", "140 W"))
...
### **Figure 1) Map.** <span style="font-size: 16pt">Estimated shipping route (gray) and potential turtle deployment locations (color)</span>
...
### **Figure 2) Average weekly SST.** <span style="font-size: 16pt"> SST colors correspond to color locations on map for near real-time SST (darker dotted-line) and long-term climatology (lighter solid line)
</span>
