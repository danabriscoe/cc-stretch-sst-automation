...
#### [The ship icon represents the ]{style="font-size: 14pt"} [ location of turtle release on July 10, 2023]{style="color:green"}. The daily SST at this location is: **`r xtract_sst_recent_loc$val`°C** [`r getZ(enddate_ras)`]. <br>
...
```{r plot-top-map-ssta, fig.height= 2, fig.width = 4, fig.align="center"}
