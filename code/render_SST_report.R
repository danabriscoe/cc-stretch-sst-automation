...
redownload_small_ncdfs = function(nc_path, eov, varname, node, url,
                                   ...
                                   min_size_mb = 6.7) {
  files     <- list.files(nc_path, pattern = paste0("^", eov, "_dhw_5km_\\d{4}"), full.names = TRUE)
...
render_SST_timeseries = function(eov, eov_unit,
  ...
  rmarkdown::render(
    ...
    # here::here("code", "05_plot_SST_ts_with_18C_isotherm_potential_2026_location.Rmd"),
    # here::here("code", "04_plot_SST_ts_with_18C_isotherm_pre_cohort4_release_w_ssta.Rmd"),
    here::here("code", "06_plot_SST_ts_with_18C_isotherm_post_cohort4_release_w_ssta.Rmd"),
