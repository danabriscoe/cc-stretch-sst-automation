...
#### [Daily 5km SST is shown for **`r getZ(enddate_ras)`**, based on the latest remotely sensed data from [NOAA Coral Reef Watch](https://coralreefwatch.noaa.gov/product/5km/index_5km_sst.php).]{style="font-size: 14pt"}

#### [The ship icon represents the]{style="font-size: 14pt"}[location of turtle release on July 10, 2023]{style="color:green"}.<br>

#### [Black lines represent the 17°C isotherm. The Thermal Corridor area is outlined in white.<br><br>]{style="font-size: 14pt"}
...
#### [For each longitude, the darker lines with circles represent the weekly SST average during 2023.]{style="font-size: 14pt"}

#### [To compare the current SST values during 2023 with the long-term average for the same time period, the lighter solid lines represent the long-term monthly SST averages between 1997-2022.]{style="font-size: 14pt"}

#### [The black horizontal line at 17°C was used as a reference for optimal temperatures during turtle release.]{style="font-size: 14pt"}
